// From https://github.com/dotnet/wpf/blob/master/src/Microsoft.DotNet.Wpf/src/WindowsBase/MS/Internal/Interop/ErrorCodes.cs
    ...
    internal struct HRESULT
    {
        ...
        public override string ToString()
        {
            ...
            if (Facility == Facility.Win32)
                foreach (var publicStaticField in typeof(Win32Error).GetFields(
